...
import "../styles/project25/project25.scss"
...
export default function Project25({setDirUrl}){
    ...
    function fixNav() {
        if(window.scrollY > document.querySelector('.nav').offsetHeight + 50) {
    ...
    return(
        <div className="project25-container">
            <nav className="nav">
                <div className="container">
                    <h1 className="logo"><a href="/index.html">Do Scroll</a></h1>
                    <ul>
