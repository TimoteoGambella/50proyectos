...
import "../styles/project3/project3b.scss"

export default function Project3b({setDirUrl}){
    ...
    return(
        <>
            <div className={`project-3b-container ${(state==="close"||state==="close2")?null:"show-nav"}`}>
            ...
            <div className={`${state==="close"?"triangle":state==="close2"?"hide-triangle":"show-triangle"}`}>
            </div>
        </>
    )
}